...
export const selectGamesState = createFeatureSelector<fromGameReducers.GameState>('games');

// Assuming `adapter` is exported from your reducers file
const { selectIds, selectEntities, selectAll, selectTotal } = fromGameReducers.adapter.getSelectors();
